...
const LINKS = [
  { href: "#pieczatki", label: "Pieczątki" },
  { href: "#grawerowanie", label: "Grawerowanie" },
    ...
    <div className="px-4 py-5 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8">
      <div className="relative flex items-center justify-between">
        ...
        <div className="lg:hidden">
          ...
          {isMenuOpen && (
            <div className="transition ease-in-out absolute z-10 top-0 left-0 w-full">
              <div className="p-5 bg-white border rounded shadow-sm">
                <div className="flex items-center justify-between mb-4">
                  <div>
                    ...
                    >
                      <span className="text-xl font-semibold tracking-wide text-gray-800 uppercase">
                        ABC Kamea
                      </span>
                    </Link>
                  </div>
